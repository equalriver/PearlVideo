...
class PVPearlPearlDetailVC: PVBaseNavigationVC {
    ...
    lazy var headerView: UIImageView = {
        let v = UIImageView.init(image: UIImage.init(named: "pearl_pearlDetail_bg"))
        return v
    }()
    lazy var sectionHeaderView: UIView = {
        ...
        let sep = UIView()
        sep.backgroundColor = kColor_pink
    ...
    override func viewDidLoad() {
        ...
        initUI()
        title = "珍珠明细"
        naviBar.rightBarButtons = [levelUpBtn]
    }
...
extension PVPearlPearlDetailVC: UITableViewDelegate, UITableViewDataSource {
